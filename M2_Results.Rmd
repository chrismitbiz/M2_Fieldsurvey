...
- The soil better able to degrade dieldrin (Kurosol)...
  - was phylogenetically and metabolically more heterogeneous and contained less organic matter but the composition of organic matter was richer with humus and particulate carbon, relative to resistant organic carbon.
  - contained a higher diversity per unit of dieldrin and per unit carbon.
  - was metabolically associated to carbon fractions.
  - contained more and more different phylogenetic clades that were associated with dieldrin loss.
  - contained distinct community associations in samples with high dieldrin-loss. 
...
t1 <- print(paste("On average", round(sum(Z$presence == "low") / nrow(data.frame(sample_data(physeq.B.flt)$Paddock)),2),
...
t2 <- print(paste("On average", round(sum(Z$presence == "low") / nrow(data.frame(sample_data(physeq.B.flt)$Paddock)),2),
