...
- A field survey of two soils with constrasting abilities to dissipate the chlorinated xenobiotic dieldrin, indicated that the functional diversity which was associated to high dieldrin dissipation was also associated to a greater humus fraction of organic matter.  
- Carbon quality was related to the soil's functionial potential and associated to dieldrin dissepation. For example, genetic potentials of lactose, galactose, fucose, rhamnose and glycole degradation predicted high dieldrin dissipation and greater humus content.  
- The presence of some taxonomic groups were 
- From the results we speculated that soils rich in high quality carbon sources may be less able to degrade xenobitics and that xenobiotic degradation can be increased by conditioning the soil diversity and function to a metabolism of low quality carbon sources. 

  
- The soil better able to degrade dieldrin...
  - contained less organic matter but the composition of organic matter comprised of more humus and particulate carbon, relative to resistant organic carbon and it was phylogenetically and metabolically more heterogeneous per unit carbon.
  - contained a microbial community and functional metagenome that was associated to the carbon fractions.
  - had a bigger per-unit-carbon genepool for chloroaromatic and aromatic degradation pathways although no organochlorine degradation potentials (such as lindane or pentachlorophenol) were detected. 
  - contained more and more different phylogenetic clades that were associated with dieldrin loss.
  - contained distinct community associations in samples with high dieldrin-loss which were driven by different keystone taxa and environmental conditions. 
- greater long-term dieldrin degradation was associated with genetic potentials for fucose, rhamnose and glycol degradation, while less degradation with oxidative glucose degradation.
...
bacteroidales <- pathway.assoc %>% filter(taxon %in% as.vector(pf.list4$OTU))
...
kable(metadata2[c(1:6,33:36),c("Soil","Paddock", "Farm", "Dloss", "D1517", "ROC", "HUM", "POC", "CN", "HC")], caption = "Sample data (unformated)", digits = 2)
