...
p.ccaB  <- phyloseq::plot_ordination(physeq.E.flt, ord_ccaE , color = "Dloss", shape = "Dloss_fct2") +
    geom_point(aes(size =  Dloss)) +
    scale_colour_gradient(low = "cadetblue1", high = "navy")+
  ggtitle("Enzymes, Kurosol") 
...
#g3 <- ggarrange(nrow = 2, ncol = 1, p5, p6, common.legend = TRUE, legend = "right")
...
Furthermore, from figure \@ref(fig:plsheatmapsall) it was apparent that metabolic potentials that were associated with low dieldrin concentrations were also associated to POC, HUM and H but not to ROC. 



\@ref(fig:plsheatmapsku), \@ref(fig:plsheatmapsch) 
  
Presense of superpathway of fucose and rhamnose degradation predicted less dieldrin concentrations and greater dieldin losses (Fig. \@ref(fig:plsheatmapsall), fig. \@ref(fig:plsheatmapsch) and fig. \@ref(fig:plsdaratiocomp1to3). 
