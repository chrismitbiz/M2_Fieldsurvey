...
```{r pcoa, echo= FALSE,  fig.cap="Ordinations of Aitchison distances were compared for  compositions of filtered bacteria, its enzyme metagenome as predicted by Picrust2 and fungi (n = 33). Symbols represent samples and their proximity to each other indicates compositional similarity. The colour and size of symbols indicate the long-term dieldrin loss (%) of samples. The shape of symbols indicate soil type.", fig.width=9, fig.asp= 0.4, message=FALSE, warning=FALSE, results=TRUE}
...
Figure \@ref(fig:pcoa) compares the compositions of the most common bacteria (a), the gene abundances as predicted from bacterial ASVs with Picrust2 (b) and fungi (c). It only included taxa and genes that were commonly found in both soils and included 175 bacterial and 65 fungal taxa as well as 1988 enzyme encoding genes. It showed that the Kurosol contained a different microbial composition 
