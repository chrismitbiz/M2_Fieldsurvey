...
knitr::include_graphics(c("./mixomics_all.png","./mixomics_kurosol.png")  )
...
Among 410 Metacyc pathways included in sPLS regression and sPLS-DA the genetic potentials for fucose, rhamnose and glycol degradation was most predictive for high dieldrin dissipation across both soils (**Table x**, Fig. \@ref(fig:plsdaratiocomp1to3) and \@ref(fig:splskurosol)). In the Kurosol lactose and galactose degradation was most strongly associated to more dieldrin dissipation (**Table x**, Fig. \@ref(fig:splskurosol)).  
On the other hand oxidative glucose degradation (Fig. \@ref(fig:plsdaratiocomp1to3)) was associated with samples of low dieldrin disspation.  
