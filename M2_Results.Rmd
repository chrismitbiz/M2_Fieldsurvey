...
```{r xenobgraphs, fig.cap = "Comparison of all xenobiotic degradation pathways found.", message=FALSE, warning=FALSE, echo=FALSE, fig.width=9, fig.asp = 0.45, cache = TRUE}
...
kable(test, caption = "Top regression coefficients of sPLS analysis across both soils (n=33). Values are the predicted effect of metabolic pathway potentials on dieldrin concentrations") %>% kable_styling(bootstrap_options = "striped", font_size = 7) 
```
