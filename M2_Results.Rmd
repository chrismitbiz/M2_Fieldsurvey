...
physeq.B.flt = filter_taxa(physeq.B.flt, function(x) sum(x > 0) > (0.40*length(x)), TRUE) #must be present in x percent of samples
...
Figure \@ref(fig:pcoa) compares the compositions of the most abundant bacteria (a), the gene abundances as predicted from bacterial ASVs with Picrust2 (b) and fungi (c).
