...
p2 <- data.frame(sample_data(physeqF)) %>% melt(., measure.var =c("Observed", "Shannon", "pielou_ev"))  %>%
  ...
  stat_compare_means( method = "kruskal",label = "p.signif")
pdf(NULL)
p <- ggarrange(p1, p2, nrow = 2, labels = "auto", common.legend = TRUE)
x = dev.off()
p 
```
...
colours <- c("grey52", "chocolate","chartreuse4","tomato1", "wheat4",
...
# Acknowledgements
Josh Vido, Helen Haydon, Gene Drendle, Steven Batinovic, Steve Petrovski, Jen Wood
