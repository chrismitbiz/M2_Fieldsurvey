...
ASV numbers of bacteria and fungi were greater in samples with high long-term dieldrin losses (Fig. \@ref(fig:alphadloss)). 
...
y$CN <- log1p(y$CN)
y$HC <- log1p(y$HC)
pw.spls <- mixOmics::spls(x, y, ncomp =3,  mode = "regression", scale = FALSE ,keepX = c(80,80,80),logratio="CLR", )

#mixOmics::cim(pw.spls, comp = 1:2, xlab = "", title = "Across both soils", threshold = 0.5, margins = c(5, 20), )
...
<br/>
Across both soils the strongest associations of metabolic potentials to dieldrin concentrations were negative.  
  
Some general info on highly associated metacyc pathways:  
  
- Anaerobic traits
  - Starch degradation V
    - degradation of starch with help of extracellular enzymes under anaerobic conditions
  - Reductive TCA cycle
    - by anoxic photosynthetic bacteria and sulfur reducing bacteria
  - L-isoleucine 
    - is a non-polar and uncharged molecule 
...
Figure \@ref(fig:plsheatmapsall) shows 
