...
mixOmics::cim(pw.spls, comp = 1:3, xlab = "", title = "Across both soils", margins = c(5, 30), threshold = 0.4)
...
pred <- predict(pw.spls, as.matrix(x))
test <- data.frame(pred$B.hat) %>% rownames_to_column("pathway")
test2 <- test %>% dplyr::select(pathway, D1517.dim1,D1517.dim2 ) %>% filter(D1517.dim1 != 0 | D1517.dim2 != 0 ) %>% arrange(D1517.dim2)
...
pred <- predict(pw.spls, as.matrix(x))
test <- data.frame(pred$B.hat) %>% rownames_to_column("pathway")
test3 <- test %>% dplyr::select(pathway, D1517.dim1,D1517.dim2 ) %>%
...
Among 410 Metacyc pathways included in sPLS, the genentic potential for oxidative glucose degradation was the most predictive for both, high dieldrin concentrations (Fig. \@ref(fig:plsheatmapsall) and table 4) and lower dieldrin loss (Fig. \@ref(fig:plsdaratiocomp1to3)). On the other hand, the genetic potentials for fucose, rhamnose and glycol degradation was most predictive for low dieldrin concentrations and high dieldrin loss  (Fig. \@ref(fig:plsdaratiocomp1to3). 



\@ref(fig:plsheatmapsku), \@ref(fig:plsheatmapsch) and \@ref(fig:plsdaratiocomp1to3).
