...
colours <- c("grey52", "chocolate","red","gray", "wheat4",
...
nrow(data.frame(sample_data(physeq.B.flt)$Paddock))
...
```{r modulecomposition, message=FALSE, warning=FALSE, echo=FASLE, cache = TRUE }
