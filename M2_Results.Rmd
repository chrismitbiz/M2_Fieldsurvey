...
- A field survey of two soils with constrasting abilities to dissipate the aged chlorinated xenobiotic dieldrin, indicated that functional diversity which coincided with high dieldrin-dissipation was associated to organic matter which contained more humus and less resistant carbon.   
- 
- From the results we speculated that xenobiotic degradation improves if soil diversity and function is  adapated for metabolism of aromatic carbon sourced with a high turnover of resistant carbon. Soils accumulating carbon may therefore be less able to degrade xenobitics. 
...
#o__Bacillales (incl Bacillus longiquaesitum) for the rhamcat pathway (5% of the total potential) 
...
p1.1 <- p1.1 +  geom_balance(node = 6869,alpha =0.4, color = "red") +  geom_balance(node = 6485,alpha =0.2, color = "red") +  geom_balance(node = 6370, alpha =0.2, color = "red") +  geom_balance(node = 5516, alpha =0.2, color = "red")  +  geom_balance(node = 5227,alpha =0.2, color = "red")+  geom_balance(node = 4967,alpha =0.2, color = "red") #as identified with phylofactor
