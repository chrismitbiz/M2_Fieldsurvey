...
Furthermore, figure \@ref(fig:pcoa) shows that the community and genetic composition was different between 'low-loss' and 'high-loss' groups in the Kurosol (<72 % and >=72 % dieldrin loss) and in the Chromosol (<=43 % and >43 % dieldrin loss). These compositional differences between groups was more clear in the Kurosol (Permanova *p* < 0.001) but marginally significant in the Chromosol (Permanova *p* = 0.05 bacteria, *p* = 0.16 fungi)
  
Phylogenetic diversity was similiar between soils and groups of low and high dieldrin loss (Kruskal-Wallis *p* > 0.05) (Fig. \@ref(fig:phylodiv). However variation in phylogenetic diversity marginally increased in samples where dieldrin loss was high (Levene's test, *p* = 0.069).
