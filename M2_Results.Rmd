...
my_comparisons <- list( c("<=43%", ">43%"), c("<72%", ">=72%") )
#preselection 
selection <- splsda_compvec %>% filter(value.var >= 0.3 | value.var <= -0.3)
#figure                
...
Among 410 Metacyc pathways included in sPLS, the genentic potential for oxidative glucose degradation, which was greater in the Chromosol (Kruskal *p* < 0.001) was the most predictive for high dieldrin concentrations (Fig. \@ref(fig:plsheatmapsall) and table 4). Ths coincided with associations to greater ROC and lower POC and HUM concentrations. 
