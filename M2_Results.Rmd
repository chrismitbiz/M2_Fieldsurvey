...
df <- data.frame(label = tree.df$tip.label, 
                 ...
                 Family = as.vector(tax.df$family)) 
p <- ggtree(tree.df) %<+% df    +
...
```{r networkallpictureKUROSOLlowhigh, message=FALSE, warning=FALSE,echo=FALSE, fig.width=15, fig.asp = 1, cache = TRUE}
...
#sse.physeqBFC <- readRDS("/Volumes/Backup Plus/ManualFileBackup/SpiecEasiFiles/sse.physeqBF_CHROMOSOL")
#dtype <- c(rep(1,ntaxa(physeq.B.flt)), rep(2,ntaxa(physeq.F.flt)))
