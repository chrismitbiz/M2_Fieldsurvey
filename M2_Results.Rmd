...
Only 1 of the 44 chlorinated compound degradation pathways available in the Metacyc database was detected. Chlorosalicylate 

39 armomatic compound degradation pathways out of 220 
...
?spiec.easi
?pulsar.params
pargs2 <- list(rep.num=25, seed=10010, ncores=4,thresh = 0.05, pulsar.select='batch')
t2 <- system.time(
