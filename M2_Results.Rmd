...
Only in the Kurosol did the soil carbon fractions significantly associate with the composition of bacteria, the enzyme metagenome and fungi (Fig. \@ref(fig:rda)). Permutation tests for the joint effect of ROC, HUM and POC were significant for the Kurosol (*p* < 0.001) but not for the Chromosol (*p* > 0.05). 
  
Subsequent null-model comparisons to each ROC, HUM and ROC individually indicated that HUM was marginally more important than ROC for bacterial community and functional composition. For fungal community composition ROC was marginally more important (**MAKETABLE**). POC was least important. In the Kurosol, there was some grouping of samples in which the composition of bacteria and fungi associated with ROC which coincided with the lowest long-term dieldrin loss (%). On the other hand, the highest dieldrin loss (%) was observed in samples where the community composition associated with HUM (Fig. \@ref(fig:rda)). 
