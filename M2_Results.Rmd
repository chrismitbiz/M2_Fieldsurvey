...
correlation_matrix=corr.test(data.frame(sample_data(physeqB)[,c("D1517", "HUM.clr", "ROC.clr", "POC.clr", "D1517", "HC", "Dloss", "CN")]), method="spearman", adjust="holm")
