...
# Summary of results  
- Overall, from the results we speculate that soil function and diversity need to be conditioned to complex carbon sources and a versatile metabolism for soils to gain a greater capacity for degradation of xenobiotic organics.
...
- The network analysis further showed that there are unique associations between bacteria and fungi in a high-loss soil environment and as a group they were driven by humus content. 
