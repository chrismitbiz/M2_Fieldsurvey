...
kable(test, booktabs=TRUE, caption = "Top regression coefficients of sPLS analysis across both soils (n=33). Values indicate the predicted effect of metabolic pathway potentials on dieldrin concentrations") %>% kable_styling(latex_options="scale_down")
```
...
kable(test, booktabs=TRUE, caption = "Top regression coefficients of sPLS analysis across in the Chromosol (n=15). Values indicate the predicted effect of the metabolic pathway potentials on dieldrin concentrations") %>% kable_styling(latex_options="scale_down")
