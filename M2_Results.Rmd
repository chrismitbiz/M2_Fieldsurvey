...
#figure                
physeq.pw.melt2  %>% filter(OTU %in% selection$name)  %>% ggboxplot(., x = "Dloss_fct2", y = "Abundance", add = c("jitter"), scales = "free", facet.by = "COMMON.NAME", fill = "CLASS1", ylab = "Metacyc pathway (Logratio to total carbon)", xlab = "Dieldrin loss", nrow = 10, ncol = 4) + stat_compare_means( method = "kruskal",label = "p.signif") + stat_compare_means(comparisons = my_comparisons)
...
Among 410 Metacyc pathways included in sPLS, the genentic potential for oxidative glucose degradation, which was greater in the Chromosol (Kruskal *p* < 0.001) was the most predictive for high dieldrin concentrations (Fig. \@ref(fig:plsheatmapsall) and table 4). This coincided with associations to greater ROC and lower POC and HUM concentrations. 
