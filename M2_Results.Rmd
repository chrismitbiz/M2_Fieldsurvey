...
# Summary of results  
- Overall, from the results we speculate that soil function and diversity needs to be conditioned to humus for soils to gain a greater capacity for xenobiotic degradation.
- The results show that carbon quality was related to the soil's functional diversity and associated to dieldrin dissepation. For example, genetic potentials of lactose, galactose, fucose, rhamnose and glycole degradation predicted high dieldrin dissipation and concurrently greater humus content.  
- Some groups of bacteria in the order of Acidobacteriales and Solirubrobacteriales which largely contributed to these genetic potentials were also more likely to be present in 'high-loss' samples.  
...
- By contrast, the genetic potential of oxidative glucose degradion was associated with low dieldrin dissipation. Rhizobiales bacteria (N-fixing rhizobia) contained the biggest abundance of this pathway potential from Picrust2. - The network analysis further showed that there are unique associations between bacteria and fungi in a high-loss soil environment and as a group they were driven by humus content. 
